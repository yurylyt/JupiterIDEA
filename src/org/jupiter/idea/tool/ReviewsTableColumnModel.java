 ...
 * Time: 16:25
 */
public class ReviewsTableColumnModel extends DefaultTableColumnModel {
    public ReviewsTableColumnModel(ResourceBundle bundle) {
    ...
    private void createColumns(final ResourceBundle bundle) {
        ...
        // Severity column
        column = new TableColumn(ReviewsTableModel.COLUMN_SEVERITY);
        ...
        // Type column
        column = new TableColumn(ReviewsTableModel.COLUMN_TYPE);
        column.setCellRenderer(bundleRenderer);
        ...
        // Status column
        column = new TableColumn(ReviewsTableModel.COLUMN_STATUS);
        column.setCellRenderer(bundleRenderer);
        ...
        // Summary column
        column = new TableColumn(ReviewsTableModel.COLUMN_SUMMARY);
        column.setHeaderValue(bundle.getString("columnHeader.label.summary"));
        column.setPreferredWidth(400);
        this.addColumn(column);

//        // File column
//        column = new TableColumn(ReviewsTableModel.COLUMN_FILE);
//        column.setHeaderValue(bundle.getString("columnHeader.label.file"));
//        this.addColumn(column);
//
//        // Line column
//        column = new TableColumn(ReviewsTableModel.COLUMN_LINE);
//        this.addColumn(column);
    }
}
